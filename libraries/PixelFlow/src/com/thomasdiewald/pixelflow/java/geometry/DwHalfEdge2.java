...
//
//      // allocate
//      edges = new DwHalfEdge2.Edge[edges_count];
//      faces = new DwHalfEdge2.Face[faces_count];
//      verts = new DwHalfEdge2.Vert[verts_count];
//      
//      // edgemap, for finding edge-pairs
//      HashMap<DwPair<Integer>, DwHalfEdge2.Edge> edgemap = new HashMap<DwPair<Integer>, DwHalfEdge2.Edge>();
//      
//      // setup edges/faces
...
//          edges[edge_id + j] = new DwHalfEdge2.Edge(ifs_faces[i][j]); 
//        }
//        
...
//        }
//        
//        faces[i] = new DwHalfEdge2.Face(edges[edge_id]); // face-link
//        edge_id += num_edges;
//      }
//
//      // setup edge-pairs
//      for(DwHalfEdge2.Edge edge : edges){
//        edge.pair = edgemap.get(DwPair.BA(edge)); // pair-link
//        verts[edge.vert] = new DwHalfEdge2.Vert(edge);  // vertex-link
//      }
//    }
//    
//    
...
//      DwHalfEdge2.Vert vert = verts[vertex_id];
//      DwHalfEdge2.Edge edge = vert.edge;  
//      DwHalfEdge2.Edge iter = edge;
//      int count = 0;
//      do {
//        count++;
...
//     */
//    public int getVertexEdges(int vertex_id, DwHalfEdge2.Edge[] edges){
//      DwHalfEdge2.Vert vert = verts[vertex_id];
//      DwHalfEdge2.Edge edge = vert.edge;  
//      DwHalfEdge2.Edge iter = edge;
//      int count = 0;
...
//    }
//
//    private void displayPolygons(PGraphics3D pg, DwHalfEdge2.Edge edge){
//      DwStack<DwHalfEdge2.Edge> stack = new DwStack<DwHalfEdge2.Edge>();
//      stack.push(edge);
...
//    }
//     
//    private void displayQuads(PGraphics3D pg, DwHalfEdge2.Edge edge){
//      DwStack<DwHalfEdge2.Edge> stack = new DwStack<DwHalfEdge2.Edge>();
//      stack.push(edge);
//      float[][] verts = ifs.getVerts();
//      float[] v;
...
//    }
//    
//    private void displayTriangles(PGraphics3D pg, DwHalfEdge2.Edge edge){
//      DwStack<DwHalfEdge2.Edge> stack = new DwStack<DwHalfEdge2.Edge>();
//      stack.push(edge);  
//      float[][] verts = ifs.getVerts();
//      float[] v;
...
//
//    
//    private boolean getFLAG_display(DwHalfEdge2.Edge edge){
//      return ((edge.FLAG ^ DISPLAY_BIT) & DISPLAY_BIT_MASK) != 0;
//    }
//    
//    private void setFLAG_display(DwHalfEdge2.Edge edge){
